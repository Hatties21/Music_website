			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
                        <h1 style="text-align:center;color:rgb(68, 92, 148)">Đăng nhập</h1>
					</div>
				</div>
					...
					<form action="login_process.php" method="POST">
						...
						<div class="form-group">
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="customControlInline">Đồng ý các điều khoản!</label>
							</div>
						</div>
						<div class="d-flex justify-content-center mt-3 login_container">
				 	        <button type="submit" name="submit" class="btn btn-warning" class="btn login_btn">Đăng nhập</button>
				        </div>
					</form>
				</div>
				<div class="mt-4">
